...
import { Kafka, type ProducerEvents, type Producer } from 'kafkajs'
...
describe('tests kafkaJSProducerPrometheusExporter', () => {
  ...
  const metrics: string[] = [
    ...
    'kafka_producer_request_duration', 'kafka_producer_request_total', 'kafka_producer_request_size_total', 'kafka_producer_request_queue_size'
  ]
