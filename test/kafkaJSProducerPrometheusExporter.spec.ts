...
describe('tests kafkaJSProducerPrometheusExporter', () => {
  ...
  test('test if all metrics are registered in registry', () => {
    ...
    expect(register.getSingleMetric('kafka_producer_connections')).toBeDefined()
    ...
    expect(register.getSingleMetric('kafka_producer_requests_total')).toBeDefined()
    expect(register.getSingleMetric('kafka_producer_requests_size_max')).toBeDefined()
    expect(register.getSingleMetric('kafka_producer_request_queue_size')).toBeDefined()
