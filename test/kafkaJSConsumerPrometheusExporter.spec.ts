...
describe('tests kafkaJSConsumerPrometheusExporter', () => {
  ...
  const metrics: string[] = [
    ...
    'kafka_consumer_request_size_total', 'kafka_consumer_request_queue_size', 'kafka_consumer_fetch_duration', 'kafka_consumer_fetch_latency',
    'kafka_consumer_fetch_total', 'kafka_consumer_batch_size_total', 'kafka_consumer_batch_duration', 'kafka_consumer_batch_latency'
  ]
